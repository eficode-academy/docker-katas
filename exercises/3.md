...
Now that you are familiar with starting, stopping and port forwarding containers, lest head over to [exercise 4](./4.md) to learn how to build your own docker files.
